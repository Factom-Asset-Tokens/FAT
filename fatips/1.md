...
This document describes the **FAT-1** token standard: A non-fungible(NF) token standard. This this standard allows for token systems supporting unique, indivisible tokens issued in whole units. It is is most equivalent the ERC-721 token standard of Ethereum.
...
```json
{
   ...
   "outputs:": {
      "FA3aECpw3gEZ7CMQvRNxEtKBGKAos3922oqYLcHQ9Nqw9e8f3LIO": [0,{"min": 10, "max":4410}, 50]
   },
