...
### Issuance Chain ID Derivation  `extends` [FAT-100](100.md)
...
```json
{
  ...
  "tokens": [
    ...
    //From FATIP-101  
      "idNonce": "33fc6aa3d395319656d793de11526b2e8833515a60abd05991e29de69c9dce9d",
    ...
    },
    {
      ...
      "idNonce": "58b1c1be5725fd7f6dd4454d523188b6598370c06661b84c5dfdb5ef41a87b8b",
...
| tokens[n].salt        | string | Random string to be hashed into token idNonce                |                                                            | Y        |
| tokens[n].idNonce     | string | a hash of the individual token information                   | sha256d(tokenID + salt). 256 bytes                         | Y        |
...
Inherits directly from the [FAT-0](/) standard.
...
```json
{
  ...
  "idNonce": "7b22c08c3b2b79c81a9b9dc9e18bf56ed9175775931e504107138d1bad24a8b7",
...
|                     |         |                                                              |                                                            |          |
| txSalt              | number  | Random numeric nonce                                         | Integer with at least 1 digit                              | Y        |
| txNonce             | number  | djb2a hash of tokenID and salt to prevent replay. Used as FCT tx timestamp (no FAT enforcement) | djb2a(tokenId + txSalt)                                    | Y        |
