...
without invalidating the signatures and the entry content itself. All FAT token
standards can adopt this standard for their signing requirements to avoid the
above mentioned replay attacks.
...
The External IDs of an entry contain the set of RCD/Signature pairs required by
...
valid for 24 hours at some point in the future.
