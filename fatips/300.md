...
{  
   ...
   "result":{  
      ...
      "salt":"874220a808090fb736f345dd5d67ac26eab94c9c9f51b708b05cdc4d42f65aae",
       "extIds":[
           "fb736f345dd5d67ac26eab94c9c9f51b708b05c"
       ]
   }
}
```
...
{  
   ...
   "result":{
      ...
      "salt":"80d87a8bd5cf2a3eca9037c2229f3701eed29360caa975531ef5fe476b1b70b5",
       "extIds":[
           "fb736f345dd5d67ac26eab94c9c9f51b708b05c",
           "qifu3ino28381n2937n1293mi912kfmlasfkasdkmfasdfasdf",
           "f2on3p2u123n712n387nf19msov2jbmurbhimsdo",
           "mvnansuvbeybqyyyewvyqv273212oi3onbvttbywtybhxzzxuv",
       ]
   }
}
```
...
| `tx-id`       | string | The tx ID to take as the starting point for the page page (inclusive of tx `tx-id`) | Must be a valid FAT tx in the set of txs matching `nf-token-id` and/or `fa-address` or neither, if unspecified. If omitted, the results are the most recent 25 transactions. | N        |
...
| `extids` | array  | The array of hex encoded ed25519 signatures & RCDs (extids) for each transaction input | Must be valid Signatures & RCDS as per the transaction implementation of the token spec. | Y        |
