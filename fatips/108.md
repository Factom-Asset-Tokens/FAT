...
```
_For example, if a contract requires 10000 opcodes for execution with 5000 GR1 operands @ 0.005 EC, 3000 GR2 operands @ 0.0075 EC, and 2000 GR3 operands @ 0.01 EC, (ignoring network writes) the total gas cost would compute to approximately $0.174 {~ 174 EC = 67 EC + 7 EC (5 % band) + 100 EC (processing incentive)._
