...
the ordered set of External IDs of the first entry in a chain, called Chain
Name IDs.
...
| ------------------------------------- | -------- | ---------------------- | -------- | ------------------------------------------- | -------- |
| Token Chain ([FATIP-0](0.MD))         | "token"  | \<Token ID> (Unicode)  | "issuer" | \<Issuer Identity Root Chain ID> (32 bytes) | -        |
