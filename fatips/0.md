...
| ----------------- | -------------------------------------------- |
| 0                 | "token"                                      |
| 1                 | \<Hex Encoded Issuer Identity Root Chain ID> |
| 2                 | \<Token ID>                                  |
|                   |                                              |
...
```
Chain ID = sha256(sha256("token") | sha256("888888dd9e60c1f0216f753caf5c9b5be4c9ca69db27a6c33d30dce3fe5ee709") | sha256("mytoken"))
...
```
Chain ID = sha256(sha256("token") | sha256("888888dd9e60c1f0216f753caf5c9b5be4c9ca69db27a6c33d30dce3fe5ee709") | sha256("mytoken") | sha256("transactions"))
Chain ID = 0x85ab32f9748bf4c24cedb301bc5a4938eb5cd4a5b0bb46b70027bf983f579a2e
```
